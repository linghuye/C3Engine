...
public:
	...
	// 2.若指针为空,将使用ini配置的纹理.
	virtual void SetTexture(C3DTexture* pTex, C3DTexture* pMixTex, int nMixOpt) = 0;
	...
	virtual bool Draw3D(const D3DXMATRIX& matInplace, const D3DXMATRIX& matTranslate, int nAsb = D3DBLEND_SRCALPHA, int nAdb = D3DBLEND_INVSRCALPHA) = 0;
};
