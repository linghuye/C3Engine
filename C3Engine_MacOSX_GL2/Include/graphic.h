...
public:	// 3d relative
	...
	static bool Flip();
	static bool Flip(C3_RECT& source, C3_RECT& dest, HEAGLDRAWABLE hEaglDrawable);
	// 准备绘制精灵
	...
	// 重置视口大小,即最后在窗口中的成像大小.
	static bool ChangeViewportResolution(DWORD dwWidth, DWORD dwHeight);
	...
	static void SetRenderTargetView(HEAGLDRAWABLE nsView);
	...
	static void DrawTrianglesUp(D3DXVECTOR3* pVertices, D3DXVECTOR2* pTexCoords, DWORD* pVertexColors, D3DXVECTOR3* pVertNormals, 
								...
								C3Texture* pTex, DWORD dwColor, DWORD dwAsb, DWORD dwAdb, D3DXMATRIX* pMatWorld);
