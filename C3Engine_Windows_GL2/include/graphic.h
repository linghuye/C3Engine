...
public:
	...
	// 自动根据当前Orientation修改镜头的设置
	// Note: 由于GameCameraSet设置的镜头位置,是由具体的游戏逻辑决定的数值(比如,魔域游戏的镜头随着人物移动而移动),
	// 所以,GameCameraSetOrientation时,底层不会去修改镜头位置这个跟上层逻辑相关的数值.
	// 上层应该根据游戏的具体逻辑坐标设置镜头中心.
