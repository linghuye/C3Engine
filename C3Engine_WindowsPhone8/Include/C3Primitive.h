...
typedef enum 
{
	...
	RENDER_TEXT_ANTIALIAS_FLAG = 0x80000000
}	RENDER_TEXT_STYLE;

//#define RENDER_TEXT_ANTIALIAS_FLAG 0x80000000// 附加抗锯齿,如: RENDER_TEXT_SILHOUETTE | RENDER_TEXT_ANTIALIAS
...
typedef enum
{
	...
	C3_SHADOW_3D_POINT_PLANAR		= 3,	// 全3D,SetShadowInfo设置的x,y,z是相对模型原点(即模型坐标系)的点光源位置.
